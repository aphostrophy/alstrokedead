...
/*** PENAMBAHAN ELEMEN ***/
void InsVFirst_LinkedList (List *L, infotype X);
...
/*** PENGHAPUSAN ELEMEN ***/
void DelVFirst_LinkedList (List *L, infotype *X);
...
void InsertFirst_LinkedList (List *L, address P);
...
void DelFirst_LinkedList (List *L, address *P);
/* I.S. List tidak kosong */
