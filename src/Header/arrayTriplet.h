...
#define CostUndef -1
#define NamaLengthUndef 0
/* Nilai elemen tak terdefinisi*/

/* Definisi elemen dan koleksi objek */
typedef int IdxType;  /* type indeks */
typedef Triplet Triplet_ElType;   /* type elemen tabel */
typedef struct { 
  Triplet_ElType TI[IdxMax+1]; /* memori tempat penyimpan elemen (container) */
} Triplet_TabInt;
/* Indeks yang digunakan [IdxMin..IdxMax] */
/* Indeks ke-0 digunakan */
/* Jika T adalah Triplet_TabInt, cara deklarasi dan akses: */
/* Deklarasi : T : Triplet_TabInt */
/* Maka cara akses: 
...
/* ********** SELEKTOR ********** */
#define Triplet_Elmt(T,i) (T).TI[(i)] //Triplet
#define Triplet_Cost(T,i) (T).TI[(i)].cost // Int
#define Triplet_Nama(T,i) (T).TI[(i)].nama // Kata
#define Triplet_NamaLength(T,i) (T).TI[(i)].nama.Length // Int dari Kata
#define Triplet_Bahan(T,i) (T).TI[(i)].bahan // Kata
#define Triplet_BahanLength(T,i) (T).TI[(i)].bahan.Length // Int dari Kata
...
Triplet_TabInt ArrayTriplet_PlusMinusTab (Triplet_TabInt T1, Triplet_TabInt T2, boolean plus);
...
boolean ArrayTriplet_IsEQ (Triplet_TabInt T1, Triplet_TabInt T2);
...
/* ********** NILAI EKSTREM ********** */
void ArrayTriplet_MaxMin (Triplet_TabInt T, Triplet_ElType * Max, Triplet_ElType * Min);
