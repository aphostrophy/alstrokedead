...
#include "./arrayTriplet/arrayTriplet.h"
...
int cmap; int state; int pmoney; int count_aksi, need_money, need_time;
...
void PrintMainDay() {
	...
	printf("\n");
	printf("=================================Queue antrian pengunjung===========================");printf("\n");
	PrintQueue(QGLOBAL);
	printf("==========================Pengunjung yang sedang menaiki wahana=====================");printf("\n");
	PrintQueue(MGLOBAL);
}
